...
public class AddDominoButtonLoader extends ComponentLoader {
    ...
    public AddDominoButtonLoader(IBaseGameActivity pGameActivity) {
        ...
        mTextureRegionClicked = BitmapTextureAtlasTextureRegionFactory.createFromAsset(mBitmapTextureAtlas, pGameActivity.getContext(), "domino.png", AddDominoButton.DOMINO_WIDTH, 0);
