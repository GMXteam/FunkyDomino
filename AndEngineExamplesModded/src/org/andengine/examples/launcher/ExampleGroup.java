...
public enum ExampleGroup {
    ...
    SIMPLE(R.string.examplegroup_simple, 
        ...
        TOUCH(R.string.examplegroup_touch, 
			Example.TOUCHDRAG, Example.ANALOGONSCREENCONTROL, Example.DIGITALONSCREENCONTROL, Example.ANALOGONSCREENCONTROLS, Example.COORDINATECONVERSION, Example.PINCHZOOM),
        /**
         * 
         */
